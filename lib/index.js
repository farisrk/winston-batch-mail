...
var os      = require('os');
var mailer  = require("mailer");  // TODO: instead of using mailer which is deprecated, need to switch to nodemailer
...
Mail.prototype.flush = function () {
  ...
  if (this.buffer.length > 0) {
    ...
    //   body = '<pre>' + buf[0].text + '</pre>';
    // //   body = buf[0].text;
    //
    // } else {

      subject = buf.length + ' error(s) on ' + os.hostname();
      body = '';
